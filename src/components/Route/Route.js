...
export default function Route({ startPointName, startDate, finishPointName, finishDate, icebreaker }) {
    return (
        <div className="route">
            <div className="route__block">
                <div className="route__point">
                    <span className="route__point-name">
                        {startPointName}
                    </span>
            ...
            {icebreaker && 
                <div className="route__icebreaker">
                    ...
                    <p className="route__icebreaker-class">{icebreaker.icebreakerClass}</p>
                </div>
            }
        </div>
    );
